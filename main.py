...
def main():
    ...
    #         fake_logit = GaitSimpleNet(predict_silhouette, training=True)
    ...
    # @tf.function
    # def train_GaitSimpleNet(subject, angle, image_ang1, image_ang2):
    ...
    #         real_logit = GaitSimpleNet(image_ang2, training=True)

    #         real_loss, fake_loss = GaitSimpleNet_Loss(real_logit, fake_logit)
    #         dLoss = (fake_loss + real_loss)

    #     D_grad = t.gradient(dLoss, GaitSimpleNet.trainable_variables)
    #     GaitSimpleNet_optimizer.apply_gradients(
    #         zip(D_grad, GaitSimpleNet.trainable_variables))
